...
import { useCreateAccount } from '../peregrine/useCreateAccount';
    ...
    return (
        ...
        >
            ...
            <Field
                ...
                label={formatMessage({
                    id: 'createAccount.customerMobileNumberText',
                    defaultMessage: 'Mobile Number'
                })}
            >
                <TextInput
                    id="customer_mobile_number"
                    field="customer.customer_mobile_number"
                    autoComplete="family-name"
                    validate={isRequired}
                    validateOnBlur
                    mask={value => value && value.trim()}
                    maskOnBlur={true}
                    data-cy="customer-customerMobileNumber"
                    aria-label={formatMessage({
                        id: 'global.customerMobileNumberRequired',
                        defaultMessage: 'Customer Mobile Number Required'
                    })}
                />
            </Field>
            <Field
